...
const EachRestaurant = () => {
    ...
    let pagenum = sampleLocation.pathname.split("/")[2]
    ...
    useEffect( ()=> {
        ...
        fetch(`http://127.0.0.1:8000/restaurants/get_blogs/${pagenum}`)
            .then(response => response.json())
            .then(json => {
                setRestaurantBlogDetail(json)
            })
        fetch(`http://127.0.0.1:8000/restaurants/get_comments/${pagenum}`)
            .then(response => response.json())
            .then(json => {
        ...
        <div>
            ...
            <div id="background">
                <div id="info_div">
                    ...
                    <div id="info_right">
                        <img
                            src={`http://localhost:8000${restaurantDetail.logo}`}
                    ...
                    <div className="container" id="popular_food">
                        <div className="row">
                            ...
                            <div className="col-md-1">
                                <Link to={`/restaurant/all_menu/${pagenum}`}>
                    ...
                    <div className="container" id="popular_blog">
                        <div className="row">
                            ...
                            <div className="col-md-1">
                                ...
                                <Link to={`/restaurant/all_blog/${pagenum}`}>
                    ...
                    <div id="blog_section" className="composing">
                        <div id="post_list" className="pic_composing">
                            ...
                            {restaurantBlogDetail.results && restaurantBlogDetail.results.map( (blog,index) =>
                                {
                                    return<>
                                        <div className="card" id="first_post" key={index}  style={aStyle} onClick={(e)=>toBlog(e,blog.id)}>
                ...
                <div id="comments">
                    <div className="container" id="popular_comment">
                        <div className="row">
                            ...
                            <div className="col-md-1">
                                <Link to={`/restaurant/all_comment/${pagenum}`}>
