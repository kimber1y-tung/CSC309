...
class Following(models.Model):
    ...
    like_status = models.IntegerField(default=0) # one is like,two is dislike
...
class Rated(models.Model):
    ...
    users = models.ForeignKey(to=UserAccount, related_name="rated_users", blank=True, on_delete=models.CASCADE)
